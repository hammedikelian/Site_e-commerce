...
`mobile` (phones and tablets), `phone` or `tablet`. This will disable AOS on th�se certains devices. But if you want make your own condition, simple type your statement insteAd of device type name:
